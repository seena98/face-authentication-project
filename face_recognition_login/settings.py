"""
Django settings for face_recognition_login project.
...
SECRET_KEY = 'ofeu3&-*y$&v^$x4p4i&w!0(ssqav=(bzeyx-9)(g8et!k87yd'
...
AUTH_USER_MODEL = 'authentication.CustomUserEntity'
...
WSGI_APPLICATION = 'face_recognition_login.wsgi.application'
